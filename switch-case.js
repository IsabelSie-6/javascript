...
switch (classe) { 
    ...
    console.log("Habilidades: Precisão, Agilidade, Tiro de precisão"); 
    break;
    case "Ladino": 
    ...
    console.log("Habilidades: Furtividade, Trapas, Assasinio");
    break; 
default: 
console.log(" Classe desconhecida. Por favor, escolha entre gierreiro, mago, arqueiro e ladino.")
}